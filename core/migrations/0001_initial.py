    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_title', models.CharField(db_index=True, default=None, max_length=150, unique=True)),
                ('product_description', models.TextField(default=None, verbose_name='Product Description')),
                ('condition', models.CharField(choices=[('New with tags', 'New with tags'), ('New without tags', 'New without tags'), ('Very Good', 'Very Good'), ('Good', 'Good'), ('Satisfactory', 'Satisfactory')], default='Not decided', max_length=20, verbose_name='Condition')),
